      ...
      return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, background: '#0b1020', color: '#e2e8f0', fontFamily: 'system-ui, sans-serif', textAlign: 'center' }}>
          <div style={{ maxWidth: 420 }}>
            <h1 style={{ fontSize: 20, marginBottom: 12 }}>ClanChat couldn't start</h1>
...
try {
  ...
  if (root) root.innerHTML = '<div style="min-height:100vh;display:flex;align-items:center;justify-content:center;padding:24px;background:#0b1020;color:#e2e8f0;font-family:system-ui,sans-serif;text-align:center"><div><h1 style="font-size:20px">ClanChat couldn\'t start</h1><pre style="white-space:pre-wrap;font-size:12px">' + String(e?.message || e) + '</pre></div></div>'
}
