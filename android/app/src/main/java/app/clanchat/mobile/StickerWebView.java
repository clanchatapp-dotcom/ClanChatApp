 ...
 * turn them into a data: URL and dispatch a DOM CustomEvent ('clanKeyboardSticker') that the web
                ...
                (InputContentInfoCompat info, int flags, Bundle opts) -> {
                    ...
                    try {
                        ...
                        post(() -> evaluateJavascript(
                                "window.dispatchEvent(new CustomEvent('clanKeyboardSticker',{detail:'"
                                        + dataUrl + "'}));", null));
                        return true;
                    } catch (Exception e) {
